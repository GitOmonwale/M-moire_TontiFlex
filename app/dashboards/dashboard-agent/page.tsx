    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Tableau de bord Agent</h1>
            <p className="text-gray-600">Bienvenue {agentSFDData.agentName} - {agentSFDData.sfdName}</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <GlassCard className="p-6 border-l-4 border-l-green-500 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Demandes validées</p>
          ...
          <GlassCard className="p-6 border-l-4 border-l-blue-500 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{agentSFDData.stats.montantEnAttente.toLocaleString()}</p>
          ...
          <GlassCard className="p-6 border-l-4 border-l-purple-500 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Taux validation</p>
                <p className="text-2xl font-bold text-purple-600">{agentSFDData.stats.tauxValidation}%</p>
                    ...
                    <div key={action.id} className="flex items-center justify-between p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20">
                      <div className="flex items-center gap-4">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                          action.type === 'validation' ? 'bg-green-100' : 'bg-red-100'
                        }`}>
            ...
            <GlassCard className="p-6">
              ...
              <div className="space-y-3">
                <GlassButton variant="outline" className="w-full text-left justify-start">
                  <FileCheck className="mr-3" size={20} />
                  <div>
                    <div className="font-medium">Valider en lot</div>
                    <div className="text-xs text-gray-500">Traiter plusieurs demandes</div>
                  </div>
                </GlassButton>
                ...
                <GlassButton variant="outline" className="w-full text-left justify-start">
                  ...
                  <div>
                    <div className="font-medium">Exporter rapport</div>
                    <div className="text-xs text-gray-500">Rapport d'activité</div>
                  </div>
                </GlassButton>
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Adhésions validées</span>
                  <span className="font-bold text-green-600">8</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Retraits approuvés</span>
                  <span className="font-bold text-blue-600">12</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Comptes créés</span>
                  <span className="font-bold text-purple-600">3</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Demandes rejetées</span>
