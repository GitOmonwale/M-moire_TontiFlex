...
const LoanApplication = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => router.push("/dashboards/dashboard-client/loans"), 2000);
    };
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label>Prénom</Label>
                                <Input className="bg-white/50" name="firstName" value={formData.firstName} onChange={handleInputChange} placeholder="Votre prénom" />
                            </div>
                            <div className="space-y-2">
                                <Label>Nom</Label>
                                <Input className="bg-white/50" name="lastName" value={formData.lastName} onChange={handleInputChange} placeholder="Votre nom" />
                            </div>
                            <div className="space-y-2">
                                <Label>Date de naissance</Label>
                                <Input type="date" className="bg-white/50" name="birthDate" value={formData.birthDate} onChange={handleInputChange} />
                            </div>
                            <div className="space-y-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input type="number" className="bg-white/50" name="monthlyIncome" value={formData.monthlyIncome} onChange={handleInputChange} placeholder="50000" />
                            </div>
                            <div className="space-y-2">
                                <Label>Dépenses mensuelles (FCFA)</Label>
                                <Input type="number" className="bg-white/50" name="monthlyExpenses" value={formData.monthlyExpenses} onChange={handleInputChange} placeholder="30000" />
                            </div>
                            <div className="space-y-2">
                                <Label>Historique bancaire</Label>
                                <Select value={formData.creditHistory} onValueChange={(v) => handleSelectChange('creditHistory', v)}>
                                    <SelectTrigger className="bg-white/50">
                                        <SelectValue placeholder="Choisir" />
                                    </SelectTrigger>
                                    <SelectContent>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input type="number" className="bg-white/50" name="loanAmount" value={formData.loanAmount} onChange={handleInputChange} placeholder="100000" />
                            </div>
                            <div className="space-y-2">
                                <Label>Durée (mois)</Label>
                                <Select value={formData.loanDuration} onValueChange={(v) => handleSelectChange('loanDuration', v)}>
                                    <SelectTrigger className="bg-white/50">
                                        <SelectValue placeholder="Choisir" />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input className="bg-white/50" name="loanPurpose" value={formData.loanPurpose} onChange={handleInputChange} placeholder="Description du projet" />
                            </div>
                        </div>
                    </div>
                );
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Select value={formData.guaranteeType} onValueChange={(v) => handleSelectChange('guaranteeType', v)}>
                                    <SelectTrigger className="bg-white/50">
                                        <SelectValue placeholder="Choisir" />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div>
                                ...
                                <div className="flex justify-between mt-8">
                                    ...
                                    {currentStep === totalSteps ? (
                                        ...
                                        <GlassButton type="button" onClick={handleNext} className="flex items-center">
                                            Suivant
                                            <ArrowRight className="ml-2" size={16} />
                                        </GlassButton>
                                    )}
